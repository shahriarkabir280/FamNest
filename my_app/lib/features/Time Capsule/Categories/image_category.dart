...
class _ImageCategoryState extends State<ImageCategory> {
  ...
  Widget build(BuildContext context) {
    ...
    item['file_name'] != null &&
        item['file_name'].toLowerCase().contains(widget.searchQuery.toLowerCase())).toList();
            ...
            child: Column(
              children: [
                ...
                IconButton(
                  ...
                  onPressed: () {
                    _showOptionsMenu(context, index, imageUrl, fileName);
                  },
                ),
              ],
            ),
  ...
  void _showOptionsMenu(BuildContext context, int index, String imageUrl, String fileName) {
  ...
  void _shareImage(String imageUrl) {
    if (imageUrl.isNotEmpty) {
      Share.share(imageUrl, subject: "Check out this image!");
    }
  }
