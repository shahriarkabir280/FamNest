...
//
//                 // Truncate the file name if it's longer than 20 characters and append "..."
//                 String displayFileName = fileName.length > 20
...
//                     onTap: () {
//                       if (fileUrl != null) {
//                         // Pass URL instead of file path to the player
//                         Navigator.push(
//                           context,
//                           MaterialPageRoute(
...
//                           const SnackBar(content: Text("Audio file URL not found")),
//                         );
//                       }
//                     },
//                     trailing: Row(
...
//                           onPressed: () => widget.onRename('Voices', index),
//                         ),
//                         IconButton(
//                           icon: const Icon(Icons.delete),
//                           onPressed: () => widget.onDelete('Voices', index),
//                         ),
//                       ],
//                     ),
//                   ),
...
//   }
//
//   // Method to handle playing audio
//   void _playAudio(String url) async {
//     try {
//       await audioPlayer.setUrl(url); // Use URL instead of file path
...
//                       .toList();
//
//                   Share.shareXFiles(selectedUrls.cast<XFile>(),
//                       text: "Check out these audio files!");
//                 } else {
//                   ScaffoldMessenger.of(context).showSnackBar(
//                     const SnackBar(
...
// import 'package:flutter/material.dart';
// import 'package:just_audio/just_audio.dart';
// import 'package:share_plus/share_plus.dart'; // Remove import for flutter_downloader
//
// import 'AudioPlayerPage.dart';
//
// class AudioCategory extends StatefulWidget {
...
//                                   widget.onDelete('Voices', index),
//                             ),
//                             // Remove the download button as per your request
//                           ],
//                         ),
//                       ),
//                     );
